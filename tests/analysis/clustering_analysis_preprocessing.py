...
class ClusteringAnalysisPreprocess:
	...
	def preprocessing(self, OHLCV, clusters):
		"""
		...
		for i, row in tqdm(clusters.iterrows(), desc='Preprocessing data for clustering analysis', total=len(clusters['index'].unique()), ncols=100):
